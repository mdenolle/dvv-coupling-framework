...
**Figure S7.** Detailed nonlinear-elasticity diagnostics from $\delta v/v$--strain crossplots, including tidal/thermal strain, linear and nonlinear velocity response, and curvature from higher-order nonlinearity
...
**Figure S9.** Logarithmic healing models, including sensitivity to $\tau_{\max}$ and $\tau_{\min}$, a Parkfield-like synthetic time series, and the $\sim 1/t$ healing-rate decay


![](../../figures/notebooks/fig15_homogeneous_validity.png){width=95%}

**Figure S10.** Detailed homogeneous-half-space validity tests, including sensitivity kernels, peak sensitivity depth versus frequency, and relative error from velocity contrasts within the sensitivity kernel


![](../../figures/notebooks/fig16_linearity_validity.png){width=95%}

**Figure S11.** Validity of the linear acoustoelastic approximation $\delta v/v = \beta\epsilon_{kk}$ as a function of strain magnitude, including tidal, thermoelastic, and coseismic/strong-motion regimes


![](../../figures/notebooks/fig18_regime_diagram.png){width=95%}

**Figure S12.** Detailed regime diagram showing which physical process dominates $\delta v/v$ as a function of measurement frequency and depth sensitivity, including capillary/vadose-zone, hydrological, thermoelastic, and tectonic domains
