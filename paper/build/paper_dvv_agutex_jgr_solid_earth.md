...
neglecting the comparatively small density-change term (\textasciitilde{}2–3 orders smaller; §2.6). The thermoelastic stress sensitivity is therefore the *same* shear-modulus pressure derivative $\mu'$ that appears in the induced-stress relation (Eq. 4) and, through the bridge relation (Eq. 7), in the acoustoelastic parameter $\beta = -\mu'\kappa/(2\mu)$. A single depth profile $\mu'(z)$ thus governs the thermoelastic, hydrological, and tectonic limbs of the framework — which is why the published ranges for $\partial(\rho v^2)/\partial\sigma_c$ (\textasciitilde{}50–1000; §3.3) and for $\mu'$ (Fokker et al., 2021) coincide. This identity is the quantitative core of the "unified" framework and is the basis for the consistency expectation in §10.1.
...
where $K(z, f)$ is the Rayleigh or Love wave phase-velocity sensitivity kernel at frequency $f$ (Figure 6a). The peak sensitivity depth is approximately $V_s / (3f)$, ranging from \textasciitilde{}50 m at 2 Hz to \textasciitilde{}5 km at 0.1 Hz for typical crustal velocities.
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{figures/main/fig02_hydrological_competition.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{figures/main/fig03_material_sensitivity.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{figures/main/fig04_rheology_diagnostics.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=\textwidth,height=0.72\textheight,keepaspectratio]{figures/main/fig06_depth_kernels.png}
\caption{Frequency-dependent depth sensitivity and inversion limits. (a) Schematic Rayleigh/Love sensitivity kernels showing broad, overlapping depth sensitivity for representative frequency bands. (b) Peak sensitivity depth $z_{\mathrm{peak}} \approx V_S/(3f)$ for soft sediment, weathered rock, and crystalline rock. (c) Relative uncertainty reduction for independent versus correlated frequency bands.}
\end{figure}
